  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 relative overflow-hidden font-sans text-white">
      <div className="relative z-10 w-full max-w-md">
        ...
        {/* 5. Terminal Feedback Message */}
        {message && (
          <div className="mt-6 p-4 bg-red-500/10 border border-red-500/30 text-red-400 rounded-xl text-[10px] w-full font-mono text-center tracking-widest leading-relaxed">
